...
struct ParticleEmitterAnnotation : das::ManagedStructureAnnotation<ParticleEmitter, false>
{
    ParticleEmitterAnnotation(das::ModuleLibrary &ml) : ManagedStructureAnnotation("ParticleEmitter", ml)
    {
        ...
        addField<DAS_BIND_MANAGED_FIELD(red_start)>("red_start");
        addField<DAS_BIND_MANAGED_FIELD(green_start)>("green_start");
        addField<DAS_BIND_MANAGED_FIELD(blue_start)>("blue_start");
        addField<DAS_BIND_MANAGED_FIELD(alpha_start)>("alpha_start");
        addField<DAS_BIND_MANAGED_FIELD(red_end)>("red_end");
        addField<DAS_BIND_MANAGED_FIELD(green_end)>("green_end");
        addField<DAS_BIND_MANAGED_FIELD(blue_end)>("blue_end");
        addField<DAS_BIND_MANAGED_FIELD(alpha_end)>("alpha_end");
