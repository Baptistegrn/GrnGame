...
function physics.update(entities, blocks, ignoreMask, dt)
    for _, entity in ipairs(entities) do
        -- Variable Extraction (Matching C logic)
        ...
        local speedMaxX = entity.speedMaxX or 3
        ...
        elseif reqRight and not entity.rightLock then
            ...
            x = math.floor(x + 0.5) -- Equivalent to SDL_roundf
            y = math.floor(y + 0.5)
        end
