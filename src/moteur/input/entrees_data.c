...
/*
 * Tables de correspondance entre noms de touches et scancodes SDL.
 * Permet la conversion dynamique d'une chaîne (ex: "space") vers le scancode.
 */

/* Touches alphabétiques, numériques et symboles */
...
/* Touches F10-F12 et pavé numérique */
